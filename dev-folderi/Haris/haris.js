...
function traziDobitne(){
  ...
  /* Pomocu ove for petlje definisemo niz objekata "pogodci", te kreiramo varijablu brojTiketa i niz pogodjeniBrojevi
  Zatim u nizove "pogodjeniBrojevi" pushamo pogodjene brojeve za svaki Tiket.*/

  /*
  for(let i=0;i<niz.length;i++){
  var tem={};
  tem.brojTiketa=(i+1);
  tem.pogodjeniBrojevi=[];
  objekt.pogodci.push(tem);

  if(objekt.userKombinacije[i].brojTiketa == objekt.pogodci[i].brojTiketa){
  objekt.pogodci[i].pogodjeniBrojevi=niz[i].P;
  }
  }*/
